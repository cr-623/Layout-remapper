...
* Kernel level input remapping for those over-engineers. Requires [Interception by Oblitum][interception] installed. **WARNING: This works for log-in screens too.**
...
### Requirements:
PyQt6 and Interception (optional)
